...
class InfoMovieCell: UICollectionViewCell {
    ...
    var nameMovieLabel: UILabel = {
       let label = UILabel()
        ...
        label.setDimension(width: 320, height: 44)
    ...
    override init(frame: CGRect) {
        ...
        stackMain.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 20, paddingLeft: 20, paddingBottom: 20, paddinRight: 20)
    }
