...
class SlidePhotoMoviesCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        addSubview(stack)
        stack.anchor(top: imageSimilarMovies.topAnchor, left: imageSimilarMovies.rightAnchor, bottom: imageSimilarMovies.bottomAnchor, right: rightAnchor, paddingLeft: 12, paddinRight: 12)
    }
